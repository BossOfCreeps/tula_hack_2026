...
INCOMPATIBLE_PAIRS: dict[Tuple[str, str], Tuple[str, int]] = {
    ("D", "D"): ("Два доминантных лидера", 1),
    ("I", "I"): ("Два «души компании»", 2),
    ("C", "C"): ("Два педанта / аналитика", 3),
    ("D", "I"): ("Напор vs эмоции", 4),
    ("I", "D"): ("Напор vs эмоции", 4),
}

# Рискованные пары (предупреждения)
RISKY_PAIRS: dict[Tuple[str, str], Tuple[str, int]] = {
    ("D", "C"): ("Скорость vs точность", 5),
    ("C", "D"): ("Скорость vs точность", 5),
    ("I", "S"): ("Активность vs пассивность", 6),
    ("S", "I"): ("Активность vs пассивность", 6),
    ("S", "C"): ("Оба медленные, но по разным причинам", 7),
    ("C", "S"): ("Оба медленные, но по разным причинам", 7),
}
